...
class TeamPolicy
{
    ...
    {
        return $user->hasPermissionTo('member.add');
    }
    ...
    {
        return $user->hasPermissionTo('member.remove');
    }
    ...
    {
        return $user->hasPermissionTo('invitation.cancel');
    }
    ...
    {
        return ! $team->is_personal && $user->hasPermissionTo('team.delete');
    }

    /**
     * Determine whether the user can switch to this team.
     */
